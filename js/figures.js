...
function trianglePerimeter() {
  const inputSide = document.getElementById("triangleSideInput");
  const inputBase = document.getElementById("triangleBaseInput");
  const triangleSide = inputSide.value * 1;
  const triangleBase = inputBase.value * 1;

  const trianglePerimeter = calculateTrianglePerimeter(
    triangleSide,
    triangleSide,
    triangleBase
  );
...
function triangleArea() {
  const inputSide = document.getElementById("triangleSideInput");
  const inputBase = document.getElementById("triangleBaseInput");
  const triangleSide = inputSide.value;
  const triangleBase = inputBase.value;

  const triangleHeight = calculateTriangleHeight(
    triangleSide,
    triangleSide,
    triangleBase
  );
...
function circleCircunference() {
  ...
  const circleRadius = input.value;

  const circleCircunference = calculateCircleCircunference(circleRadius);
  alert(circleCircunference);
}
